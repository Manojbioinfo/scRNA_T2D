...
# ===========================
dir.create("Ins1_results_mouse", showWarnings = FALSE)
saveRDS(full_signal_mat, "Ins1_results_mouse/full_genome_signal_chr19_1kb.rds")

saveRDS(full_signal_mat_norm, "Ins1_results_mouse/full_genome_signal_chr19_1kb_normalised.rds")
