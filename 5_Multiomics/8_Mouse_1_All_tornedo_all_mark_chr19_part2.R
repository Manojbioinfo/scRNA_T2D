...
full_signal_mat=readRDS("Ins2_results/full_genome_signal_chr7_10k")
...
saveRDS(ins_signal, "Ins2_results/Ins2_signal_10kb_bins.rds")
...
saveRDS(plot_df, "Ins2_results/Ins2_plot_df_10kb.rds")
...
pdf("Ins2_results/ChIPseq_Ins2_tornado_10kb.pdf", width = 12, height = 8)
