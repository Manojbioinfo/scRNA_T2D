...
matrix_dir = "Data//"
barcode.path <- paste0(matrix_dir, "E-MTAB-5061.aggregated_filtered_counts.mtx_cols")
features.path <- paste0(matrix_dir, "E-MTAB-5061.aggregated_filtered_counts.mtx_rows")
matrix.path <- paste0(matrix_dir, "E-MTAB-5061.aggregated_filtered_counts.mtx")
...
seurat_obj<- CreateSeuratObject(counts = mat, project = "E-MTAB-5061", min.cells = 3, min.features = 100)

seurat_ids <- colnames(seurat_obj)

pheno_file=read.csv("ExpDesign-E-MTAB-5061.tsv",sep = "\t")
...
saveRDS(srat,"5061.seurat.org.rds",compress="xz")
