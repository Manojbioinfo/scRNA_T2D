...
matrix_dir = "Data//"
barcode.path <- paste0(matrix_dir, "E-GEOD-81608.aggregated_filtered_counts.mtx_cols")
features.path <- paste0(matrix_dir, "E-GEOD-81608.aggregated_filtered_counts.mtx_rows")
matrix.path <- paste0(matrix_dir, "E-GEOD-81608.aggregated_filtered_counts.mtx")
...
seurat_obj<- CreateSeuratObject(counts = mat, project = "E-GEOD-81608", min.cells = 3, min.features = 100)

seurat_ids <- colnames(seurat_obj)

pheno_file=read.csv("ExpDesign-E-GEOD-81608.tsv",sep = "\t")
...
saveRDS(srat,"81608.seurat.org.rds",compress="xz")

data1=readRDS("81608.seurat.org.rds")
dim(data1)
