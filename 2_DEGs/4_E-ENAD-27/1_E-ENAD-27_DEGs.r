...
srat=readRDS("../1_Data/27.seurat.org.rds")
...
# 32102 features across 1060 samples within 1 assay 
# Active assay: RNA (32102 features, 0 variable features)
...
data=subset(srat,nFeature_RNA>200 & nFeature_RNA<15000  & percent.mt < 25 )  ### This depends on the data quality
data


# n object of class Seurat 
# 32102 features across 1040 samples within 1 assay 
# Active assay: RNA (32102 features, 0 variable features)
# 1 layer present: counts
