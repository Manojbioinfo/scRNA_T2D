...
srat=readRDS("../1_Data/31.seurat.org.rds")
...
# 24546 features across 18694 samples within 1 assay 
# Active assay: RNA (24546 features, 0 variable features)
...
data=subset(srat,nFeature_RNA>200 & nFeature_RNA<5000 & nCount_RNA<10000 & percent.mt < 25 )  ### This depends on the data quality
data


# data
# An object of class Seurat 
# 24546 features across 18441 samples within 1 assay 
# Active assay: RNA (24546 features, 0 variable features)
# 1 layer present: counts
