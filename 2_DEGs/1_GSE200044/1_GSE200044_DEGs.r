...
srat=readRDS("../1_Data/GSE200044_RNA_2025.rds")
srat


# An object of class Seurat 
# 60658 features across 82880 samples within 1 assay 
# Active assay: RNA (60658 features, 2000 variable features)
...
VlnPlot(srat, features = c("nFeature_RNA","nCount_RNA","percent.mt"),ncol =3,pt.size = 0.1) & 
...
data=subset(srat,nFeature_RNA>200 & nFeature_RNA<5000 & nCount_RNA<15000 & percent.mt < 25 )  ### This depends on the data quality
data


# data
# An object of class Seurat 
# 60658 features across 79433 samples within 1 assay 
# Active assay: RNA (60658 features, 2000 variable features)
# 2 layers present: data, counts


pdf("Pic.Manoj2.pdf", width =10, height =3)
VlnPlot(data, features = c("nFeature_RNA","nCount_RNA","percent.mt"),ncol = 3,pt.size = 0.1) & 
  theme(plot.title = element_text(size=10),
        axis.text.x = element_text(angle=90))
dev.off()
