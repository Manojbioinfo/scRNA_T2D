...
srat=readRDS("../1_Data/GSE195986.scRNA.rds")
srat

# An object of class Seurat 
# 21671 features across 220000 samples within 1 assay 
# Active assay: RNA (21671 features, 0 variable features)
...
data=subset(srat,nFeature_RNA>200 & nFeature_RNA<5000 & nCount_RNA<5000 & percent.mt < 25 )  ### This depends on the data quality
data

# An object of class Seurat 
# 21671 features across 54076 samples within 1 assay 
# Active assay: RNA (21671 features, 0 variable features)
# 1 layer present: counts
