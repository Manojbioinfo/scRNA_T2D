...
srat=readRDS("../1_Data/83139.seurat.org.rds")
...
# 26897 features across 526 samples within 1 assay 
# Active assay: RNA (26897 features, 0 variable features)
# 1 layer present: counts
# 
# 
# 
# umns to object metadata. This is a great place to stash QC stats
...
data=subset(srat,nFeature_RNA>200 & nFeature_RNA<15000 )  ### This depends on the data quality
data
# data
# An object of class Seurat 
# 26897 features across 526 samples within 1 assay 
